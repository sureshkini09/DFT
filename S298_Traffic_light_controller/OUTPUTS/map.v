...
// Generated on: Mar  7 2025 16:24:16 IST (Mar  7 2025 10:54:16 UTC)
...
module s298(GND, VDD, CK, G0, G1, G117, G118, G132, G133, G2, G66, G67);
  ...
  wire G98, G102, G107, G113, G119, G125, n_0, n_1;
  ...
  OR3X2 g1225__5477(.A (n_25), .B (G14), .C (n_1), .Y (n_30));
  ...
  XNOR2X1 g1233__6783(.A (G2), .B (n_1), .Y (n_16));
  ...
  AND2X2 g1240__7098(.A (n_7), .B (n_1), .Y (n_12));
  ...
  INVX1 drc_bufs1251(.A (n_0), .Y (n_1));
  INVX1 drc_bufs1252(.A (G22), .Y (n_0));
endmodule
